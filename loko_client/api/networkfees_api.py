...
class NetworkfeesApi:
    ...
    def get_network_fees(
        ...
        _param = self._get_network_fees_serialize(
    ...
    @validate_call
    def get_network_fees_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetNetworkFees200Response]:
        """Get network fees
    ...
    @validate_call
    def get_network_fees_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_network_fees_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
