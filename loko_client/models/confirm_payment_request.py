...
class ConfirmPaymentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cryptocurrency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cryptocurrency
        if self.cryptocurrency:
            _dict['cryptocurrency'] = self.cryptocurrency.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cryptocurrency": CryptoCurrency.from_dict(obj["cryptocurrency"]) if obj.get("cryptocurrency") is not None else None
        })
        return _obj
