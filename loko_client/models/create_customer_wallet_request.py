...
class CreateCustomerWalletRequest(BaseModel):
    """
    CreateCustomerWalletRequest
    """ # noqa: E501
    currency: Optional[StrictStr] = Field(default=None, description="Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) for FIAT, three or four letter code for cryptocurrencies. Cryptocurrency code list")
    network: Optional[StrictStr] = Field(default=None, description="The cryptocurrency network")
    customer: Optional[PaymentCustomer] = None
    __properties: ClassVar[List[str]] = ["currency", "network", "customer"]
