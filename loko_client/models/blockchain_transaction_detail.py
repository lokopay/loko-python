...
class BlockchainTransactionDetail(BaseModel):
    """
    ...
    block_time: Optional[StrictInt] = None
    block_height: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "amount", "currency", "network", "address", "tx_hash", "confirmations", "block_time", "block_height"]
